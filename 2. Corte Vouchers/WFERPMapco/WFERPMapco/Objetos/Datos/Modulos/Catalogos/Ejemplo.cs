...
namespace WFERPMapco.Objetos.Datos.Modulos.Catalogos
{
    public class Ejemplo
    {
        ...
        /*CONSULTAS*/
        public Resultado obtenerEjemplo()
        {
            ...
            try
            {
                ...
                ds = dtbs.RegresaDataSet("Ejemplo", "EjemploR", ref pvarError, "MySqlBASE", sqlParametros);
                resultado.Datos = ds;
            ...
            catch (MySqlException e)
            {
                ...
                resultado.MensajeError = "[ERROR:DataBase - obtenerEjemplo]= " + e.Message.Replace("'", string.Empty).Replace("\r", string.Empty).Replace("\n", string.Empty);
                resultado.Excepcion = e;
            }
            catch (Exception e)
            {
                resultado.Error = true;
                resultado.MensajeError = "[ERROR:Exception - obtenerEjemplo]= " + e.Message.Replace("'", string.Empty).Replace("\r", string.Empty).Replace("\n", string.Empty);
                resultado.Excepcion = e;
            }
            return resultado;
        }
